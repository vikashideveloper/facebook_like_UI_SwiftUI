...
struct ContentView: View {
    var posts = [
        ...
        FBPost(id: 4, username: "Vikash Kumar", userPhoto: "profilePick", time: "15 mins", text: "Prime Minister Narendra Modi today announced the third edition of \"Pariksha Pe Charcha\", a session where he would interact with thousands of students on the ways to handle examination stress. The Prime Minister has also launched a contest for the students of Classes 9 to 12 and its winners will get an opportunity to attend the event and ask him questions.", image: "profilePick", likeCount: 100, commentcount: 150, shareCount: 10),
        
        FBPost(id: 5, username: "PV Sindhu", userPhoto: "sindhu1", time: "10 mins", text: "Pusarla Venkata Sindhu (born 5 July 1995) is an Indian professional badminton player. Having made her international debut in 2009, she rose to a career high ranking of no. 2 in April 2017. Over the course of her career, Pusarla has won medals at numerous tournaments on the BWF circuit including a gold at the 2019 World Championships thus becoming first Indian to become the Badminton World Champion.", image: "", likeCount: 100, commentcount: 150, shareCount: 10),
        
        FBPost(id: 6, username: "Virat Kohali", userPhoto: "kohali1", time: "25 mins", text: "A right-handed top-order batsman, Kohli is regarded as one of the best batsmen in the world.[3] He plays for Royal Challengers Bangalore in the Indian Premier League (IPL), and has been the team's captain since 2013. Since October 2017, he has been the top-ranked ODI batsman in the world and is currently 1st in Test rankings with 928 points.[4][5]Among Indian batsmen, Kohli has the best ever Test rating (937 points), ODI rating (911 points) and T20I rating (897 points).", image: "virat", likeCount: 100, commentcount: 150, shareCount: 10)
